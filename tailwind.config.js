  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "top-bg": "url('assets/banner-img/top-1.webp')",
        "text": "url('assets/banner-img/text-bg1.webp')",
        "mac-banner": "url('assets/banner-img/mac-banner1.webp')",
        "linear-graph": "url('assets/banner-img/graph-3.webp')",
        "boa-banner": "url('assets/banner-img/boa-banner-3.webp')",
        ...
        "thank-banner": "url('assets/banner-img/thank-banner.webp')",
        "thank-banner1": "url('assets/banner-img/thank-banner1.webp')",
      },
      backgroundColor: {
